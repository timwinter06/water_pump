...
* perform processing on data ( using functions from the helpers.py file)
* Train model
...
from helpers import feature_engineer, preprocess, finalize_data
import pickle
...
# Save encoder
outfile = open(f'{args.encode}_encoder', 'wb')
